                ...
                <div className='center'>
                    <div id='content'>
                        ...
                        <div className="form-group radibuttons">
                            <input type="radio" name="genero" value="hombre" ref={this.genderMaleRef}/> Hombre 
                            <input type="radio" name="genero" value="mujer" ref={this.genderFemaleRef}/> Mujer 
                            <input type="radio" name="genero" value="otro" ref={this.genderOtherRef}/> Otro
                        </div>
